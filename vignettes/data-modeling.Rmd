...
* `report_settings$fc_nthreads`: For the number of threads argument for parallel processing in modelling. Either 1 or 2, if multiple cores are present. 
...
* `report_settings$env_lag_length`: The number of days of past environmental data to include for the lagged effects, default is 180 days.
