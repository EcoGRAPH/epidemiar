...
* `report_settings$epi_date_type`: Should the epidemiological data be linearly interpolated for any missing values? Boolean value, default is FALSE. 
...
* `report_settings$fc_splines`: The type of splines that will be used to handle long-term trends and lagged environmental variables. If supplemental package `batchapply` is installed, the default 'tp' uses thin plate splines. If the package is not installed, then it uses modified b-splines ('modbs').
