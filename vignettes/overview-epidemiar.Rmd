...
The model family is user set, for example, you can run regression with a Poisson distribution (`fc_family = "poisson()"`) or <<>>. 
...
<<>> default = false now, talk about option
